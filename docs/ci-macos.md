...
brew install gcc ccache cmake ninja pkgconf autoconf automake libtool m4 bison flex gettext openblas openssl@3 python@3.12 neovim make gawk gnu-sed coreutils diffutils findutils grep rsync texinfo modules
```
